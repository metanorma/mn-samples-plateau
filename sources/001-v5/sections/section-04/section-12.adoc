...
|===
| トンネルモデル（LOD4）に含むべき地物 | 対応するCityGMLの地物型 | LOD4.0 | LOD4.1 | LOD4.2
...
LOD4.0、LOD4.1及びLOD4.2それぞれの取得イメージを<<tab-4-74>>に示す。
...
[[ConstructionStructureAttribute_slopeType.xml_tun]]
...
[[ConstructionBaseAttribute_adminType.xml_tun]]
...
[[ConstructionBaseAttribute_installerType.xml_tun]]
...
[[ConstructionRiskAssessmentAttribute_riskType.xml_tun]]
...
[[ConstructionRiskAssessmentAttribute_status.xml_tun]]
...
[[DataQualityAttribute_geometrySrcDesc.xml_tun]]
...
[[DataQualityAttribute_thematicSrcDesc.xml_tun]]
...
[[DataQualityAttribute_appearanceSrcDesc.xml_tun]]
...
[[DataQualityAttribute_lod1HeightType.xml_tun]]
...
[[PublicSurveyDataQualityAttribute_srcScale.xml_tun]]
...
[[PublicSurveyDataQualityAttribute_geometrySrcDesc.xml_tun]]
