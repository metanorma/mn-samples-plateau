...
====== IfcElementCompositionEnumType

[cols="3a,22a"]
|===
| 列挙型 | IfcElementCompositionEnumType
...
[cols="3a,22a"]
|===
| 列挙型 | IfcInternalOrExternalEnumType
...
====== IfcTransportElementTypeEnumType
...
[cols="a,a"]
|===
| 列挙型 | IfcTransportElementTypeEnumType
