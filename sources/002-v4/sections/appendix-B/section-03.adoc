...
image::images/117.webp.png[title="エラーとなるgml:LineStringの例"]
...
image::images/118.webp.png[title="エラーとなるgml:LinearRingの例"]
...
image::images/119.webp.png[title="gml:Polygonの向き"]
...
image::images/120.webp.png[title="gml:Polygonの例"]
...
image::images/121.webp.png[title="gml:OrientableSurfaceの例"]
...
image::images/122.webp.png[title="gml:CompositeSurfaceの例"]
...
image::images/125.webp.png[title="gml:Tinの例"]
