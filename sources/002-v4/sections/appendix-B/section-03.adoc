...
image::images/117.webp[title=" 図 B-1　エラーとなるgml:LineStringの例"]
...
image::images/118.webp[title=" 図 B-2　エラーとなるgml:LinearRingの例"]
...
image::images/119.webp[title=" 図 B-3　gml:Polygonの向き"]
...
image::images/120.webp[title=" 図 B-4　gml:Polygonの例"]
...
image::images/121.webp[title=" 図 B-5　gml:OrientableSurfaceの例"]
...
image::images/122.webp[title=" 図 B-6　gml:CompositeSurfaceの例"]
...
image::images/125.webp[title=" 図B- 9　gml:Tinの例"]
