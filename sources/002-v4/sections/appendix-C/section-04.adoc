...
image::images/154.webp[title=" 図C- 17 　BuildingPartの使用例"]
...
image::images/155.webp[title=" 図C- 18 　建築物部分（bldg:BuildingPart）を使用する例"]
...
image::images/156.webp[title=" 図C- 19 　建築物部分（bldg:BuildingPart）を使用しない例"]
