...
image::images/164.webp.png[title="閉鎖面の例（出入り口等の開口部を閉鎖）"]

image::images/165.webp.png[title="閉鎖面の例（境界を閉鎖）"]

image::images/166.webp.png[title="閉鎖面の取得例（建物入口）"]
...
image::images/167.webp.png[title="天井面の例"]
...
image::images/170.webp.png[title="LOD2における境界面の区分"]
...
image::images/171.webp.png[title="屋外床面の取得例"]
...
image::images/172.webp.png[title="屋外天井面の取得例"]
...
image::images/173.webp.png[title="閉鎖面の取得例"]
