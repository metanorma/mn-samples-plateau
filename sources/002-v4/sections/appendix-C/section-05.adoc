...
image::images/157.webp[title=" 図 C -20　bldg:_BoundarySurfaceの下位型"]
...
image::images/158.webp[title=" 図 C -21　外壁面の実装例"]
...
image::images/159.webp[title=" 図C -22　 LOD2における底面の実装例"]
...
image::images/164.webp[title=" 図C- 27　閉鎖面の例（出入り口等の開口部を閉鎖）"]

image::images/165.webp[title=" 図C- 28　閉鎖面の例（境界を閉鎖）"]

image::images/166.webp[title=" 図C- 29　閉鎖面の取得例（建物入口）"]
...
image::images/167.webp[title=" 図C- 30　天井面の例"]
...
image::images/170.webp[title=" 図C- 33　LOD2における境界面の区分"]
...
image::images/171.webp[title=" 図C- 34　屋外床面の取得例"]
...
image::images/172.webp[title=" 図C- 35　屋外天井面の取得例"]
...
image::images/173.webp[title=" 図C- 36　閉鎖面の取得例"]
