...
LOD2及びLOD3では、建築物（bldg:Building）の境界面をbldg:RoofSurface（屋根面：<<tocC_05_02_01>>）、bldg:WallSurface（外壁面：<<tocC_05_02_02>>）、bldg:GroundSurface（底面：<<tocC_05_02_03>>）に区分することを基本とする。
