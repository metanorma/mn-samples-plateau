...
// lutaml_klass_table::../../sources/xmi/plateau_all_packages_export.xmi[name="IfcGeomericRepresentationContext",template="../../sources/liquid_templates/_klass_table.liquid",guidance="../../sources/guidance/guidance.yaml"]
