...
h| ^h| LOD1
h| 取得例
a| image::images/070.webp.png["",600]
...
h| ^h| LOD2
h| 取得例
a| image::images/071.webp.png["",600]
...
^a| image::images/075.webp.png["",160]
^a| image::images/076.webp.png["",160]
^a| image::images/077.webp.png["",160]
...
image::images/078.webp.png["",200]

a|
道路の横断方向に存在する15㎝以上の高さの差を取得する。 +
①高さの差が15㎝以上の段は、段の形状を取得する。

image::images/079.webp.png["",200]
...
image::images/080.webp.png["",200]

a|
②高さの差が15㎝以上のスロープは、スロープの形状を取得する。

image::images/081.webp.png["",200]

a|
②高さの差が2㎝以上のスロープは、スロープの形状を取得する。

image::images/082.webp.png["",200]

.2+a|
③高さの差が15㎝未満の段が複数あり、合計15㎝以上の高さの差がある場合は、スロープとして取得する。

image::images/083.webp.png["",200]
...
image::images/084.webp.png["",200]

a|
歩道に設けられた車道への切り下げ部に存在する段が表現できる。

image::images/085.webp.png["",200]
...
2+a| image::images/095.webp.png["",500,title=" 図　LOD2における道路の取得例"]

2+a| image::images/096.webp.png["",500,title=" 図　LOD3における道路の取得例"]
...
image::images/097.webp.png["",500,title=" 図　LOD2及びLOD3.0におけるtran:TrafficAreaの例"]

2+a|
• LOD3.1の場合は、LOD3.0の車道部のうち、車線を細分する。

image::images/098.webp.png["",500,title=" 図　LOD3.1におけるtran:TrafficAreaの例"]

2+a|
• LOD3.2及びLOD3.3の場合は、LOD3.1の歩道部から歩道上の植栽を除いた範囲を歩道部とする。

image::images/099.webp.png["",500,title=" 図　LOD3.2及びLOD3.3におけるtran:TrafficAreaの例"]

2+a|
• LOD3.4の場合は、コードリストの区分に従う。

image::images/100.webp.png["",500,title=" 図　LOD3.4におけるtran:TrafficAreaの例"]
...
image::images/101.webp.png["",500,title=" 図　LOD2、LOD3.0及びLOD3.1での道路のtran:AuxiliaryTrafficAreaの取得例"]

2+a|
• LOD3.2及びLOD3.3の場合は、上記に加え、歩道部に設置された植栽を対象とする。

image::images/102.webp.png["",500,title=" 図　LOD3.2及びLOD3.3での道路のtran:AuxiliaryTrafficAreaの取得例"]

2+a|
• LOD3.4に場合は、tran:functionにより指定されるコードリストの区分に従う。

image::images/103.webp.png["",500,title=" 図　LOD3.4での道路のtran:AuxiliaryTrafficAreaの取得例"]
