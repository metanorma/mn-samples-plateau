...
[gml_dictionary,iur/codelists/3.1/TransportationComplex_class.xml,root]
----
...
[gml_dictionary,iur/codelists/3.1/Road_function.xml,root]
----
{% render 'gml_dict_template', root: root, filename: filename %}
----
...
[gml_dictionary,iur/codelists/3.1/Road_usage.xml,root]
----
{% render 'gml_dict_template', root: root, filename: filename %}
----
...
[gml_dictionary,iur/codelists/3.1/RoadStructureAttribute_widthType.xml,root]
----
{% render 'gml_dict_template', root: root, filename: filename %}
----
...
[gml_dictionary,iur/codelists/3.1/RoadStructureAttribute_sectionType.xml,root]
----
{% render 'gml_dict_template', root: root, filename: filename %}
----
...
[gml_dictionary,iur/codelists/3.1/Road_lodType.xml,root]
----
{% render 'gml_dict_template', root: root, filename: filename %}
----
