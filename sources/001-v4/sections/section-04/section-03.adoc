...
h| 取得例
a|
image::images/068.webp.png["",300]
a|
image::images/069.webp.png["",300]
...
^a|
image::images/074.webp.png["",140]
^a|
image::images/075.webp.png["",200]
^a|
image::images/076.webp.png["",210]
^a|
image::images/077.webp.png["",230]
...
.図　LOD1における道路の取得例
image::images/094.webp.png["",300]

2+a|

.図　LOD2における道路の取得例
image::images/095.webp.png["",600]

2+a|

.図　LOD3における道路の取得例
image::images/096.webp.png["",600]
...
.図　LOD2及びLOD3.0におけるtran:TrafficAreaの例
image::images/097.webp.png["",700]

2+a|
• LOD3.1の場合は、LOD3.0の車道部のうち、車線を細分する。


.図　LOD3.1におけるtran:TrafficAreaの例
image::images/098.webp.png["",700]

2+a|
• LOD3.2及びLOD3.3の場合は、LOD3.1の歩道部から歩道上の植栽を除いた範囲を歩道部とする。


.図　LOD3.2及びLOD3.3におけるtran:TrafficAreaの例
image::images/099.webp.png["",700]

2+a|
• LOD3.4の場合は、コードリストの区分に従う。


.図　LOD3.4におけるtran:TrafficAreaの例
image::images/100.webp.png["",700]
...
.図　LOD2、LOD3.0及びLOD3.1での道路のtran:AuxiliaryTrafficAreaの取得例
image::images/101.webp.png["",700]

2+a|
• LOD3.2及びLOD3.3の場合は、上記に加え、歩道部に設置された植栽を対象とする。


.図　LOD3.2及びLOD3.3での道路のtran:AuxiliaryTrafficAreaの取得例
image::images/102.webp.png["",700]

2+a|
• LOD3.4に場合は、tran:functionにより指定されるコードリストの区分に従う。


.図　LOD3.4での道路のtran:AuxiliaryTrafficAreaの取得例
image::images/103.webp.png["",700]
