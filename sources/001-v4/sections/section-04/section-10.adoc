...
^h| ^h| LOD1
^h| 取得例
a| image::images/207.webp.png["",600]
...
image::images/228.webp.png["",250,title=" 図　都市計画区域の例"]
...
image::images/229.webp.png["",250,title=" 図　区域区分（市街化調整地域）の例"]
...
image::images/230.webp.png["",350,title=" 図　urf:DistrictsAndZones及び下位型の例"]
