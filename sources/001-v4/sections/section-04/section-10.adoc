...
image::images/228.webp["",250,title=" 図　都市計画区域の例"]
...
image::images/229.webp["",250,title=" 図　区域区分（市街化調整地域）の例"]
...
image::images/230.webp["",350,title=" 図　urf:DistrictsAndZones及び下位型の例"]
