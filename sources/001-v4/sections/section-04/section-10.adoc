...
lutaml_gml_dictionary::iur/codelists/3.1/Common_districtAndZonesType.xml[template="gml_dict_template.liquid",context=dict]
...
lutaml_gml_dictionary::iur/codelists/3.1/HeightConstrolDistrict_usage.xml[template="gml_dict_template.liquid",context=dict]
