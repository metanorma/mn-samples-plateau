...
[gml_dictionary,iur/codelists/3.1/Common_dmCode.xml,root]
----
...
[gml_dictionary,iur/codelists/3.1/Common_shapeType.xml,root]
----
{% render 'gml_dict_template', root: root, filename: filename %}
----
...
[gml_dictionary,iur/codelists/3.1/Common_MapLevel.xml,root]
----
{% render 'gml_dict_template', root: root, filename: filename %}
----
...
[gml_dictionary,iur/codelists/3.1/Common_geometryType.xml,root]
----
{% render 'gml_dict_template', root: root, filename: filename %}
----
...
[gml_dictionary,iur/codelists/3.1/DmElement_dataType.xml,root]
----
{% render 'gml_dict_template', root: root, filename: filename %}
----
...
[gml_dictionary,iur/codelists/3.1/DmElement_annotationType.xml,root]
----
{% render 'gml_dict_template', root: root, filename: filename %}
----
...
[gml_dictionary,iur/codelists/3.1/DmElement_breakType.xml,root]
----
{% render 'gml_dict_template', root: root, filename: filename %}
----
...
[gml_dictionary,iur/codelists/3.1/DmElement_dislocationType.xml,root]
----
{% render 'gml_dict_template', root: root, filename: filename %}
----
