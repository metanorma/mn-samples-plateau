...
[gml_dictionary,iur/codelists/3.1/WaterBody_class.xml,root]
----
...
[gml_dictionary,iur/codelists/3.1/WaterBody_function.xml,root]
----
{% render 'gml_dict_template', root: root, filename: filename %}
----
...
[gml_dictionary,iur/codelists/3.1/RiverFloodingRiskAttribute_adminType.xml,root]
----
{% render 'gml_dict_template', root: root, filename: filename %}
----
...
[gml_dictionary,iur/codelists/3.1/RiverFloodingRiskAttribute_scale.xml,root]
----
{% render 'gml_dict_template', root: root, filename: filename %}
----
...
[gml_dictionary,iur/codelists/3.1/RiverFloodingRiskAttribute_rank.xml,root]
----
{% render 'gml_dict_template', root: root, filename: filename %}
----
...
[gml_dictionary,iur/codelists/3.1/TsunamiRiskAttribute_rank.xml,root]
----
{% render 'gml_dict_template', root: root, filename: filename %}
----
...
[gml_dictionary,iur/codelists/3.1/HighTideRiskAttribute_rank.xml,root]
----
{% render 'gml_dict_template', root: root, filename: filename %}
----
...
[gml_dictionary,iur/codelists/3.1/InlandFloodingRiskAttribute_rank.xml,root]
----
{% render 'gml_dict_template', root: root, filename: filename %}
----
...
[gml_dictionary,iur/codelists/3.1/ReservoirFloodingRiskAttribute_rank.xml,root]
----
{% render 'gml_dict_template', root: root, filename: filename %}
----
...
[gml_dictionary,iur/codelists/3.1/LandSlideRiskAttribute_description.xml,root]
----
{% render 'gml_dict_template', root: root, filename: filename %}
----
...
[gml_dictionary,iur/codelists/3.1/LandSlideRiskAttribute_areaType.xml,root]
----
{% render 'gml_dict_template', root: root, filename: filename %}
----
...
[gml_dictionary,iur/codelists/3.1/LandSlideRiskAttribute_status.xml,root]
----
{% render 'gml_dict_template', root: root, filename: filename %}
----
