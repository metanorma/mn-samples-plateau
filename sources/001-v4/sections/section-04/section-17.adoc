...
[gml_dictionary,iur/codelists/3.1/SolitaryVegetationObject_class.xml,root]
----
...
[gml_dictionary,iur/codelists/3.1/SolitaryVegetationObject_function.xml,root]
----
{% render 'gml_dict_template', root: root, filename: filename %}
----
...
[gml_dictionary,iur/codelists/3.1/PlantCover_class.xml,root]
----
{% render 'gml_dict_template', root: root, filename: filename %}
----
