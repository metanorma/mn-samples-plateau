...
h| ^h| LOD0
h| 取得例
a| image::images/337.webp.png["",600]
...
h| ^h| LOD1
h| 取得例
a| image::images/338.webp.png["",500]
...
h| ^h| LOD2
h| 取得例
a| image::images/339.webp.png["",650]
...
h| ^h| LOD3
h| 取得例
a| image::images/340.webp.png["",500]
...
image::images/345.webp.png["",600,title=" 図　uro:UndergroundBuildingの例"]

2+a|
建築物の地階は、建築物（bldg:Building）として表現する。 +
地下街から地上に出入りするために設けられた開口部（bldg:ClosureSurface）を覆うように設けられた建屋は、frn:CityFurnitureとして取得する。

image::images/346.webp.png["",500,title=" 図　地下街の出入り口に設けられた建屋"]
