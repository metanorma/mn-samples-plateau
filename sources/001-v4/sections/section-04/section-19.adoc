...
| 取得例
2+a| image::images/385.png["",150]
2+a| image::images/386.png["",300]
...
| 取得例
a| image::images/387.png["",240]
a| image::images/388.png["",100]
a| image::images/389.png["",120]
a| image::images/390.png["",200]
...
| 4+^| LOD0（公共測量標準図式により表現する場合）
| 取得例
a| image::images/391.png["",120]
a| image::images/392.png["",200]
a| image::images/393.png["",100]
a| image::images/394.png["",50]
...
image::images/400.png["",300,title=" 図　wtr:WaterBodyの例（LOD0）"]

2+a| 
LOD1は、水涯線により囲まれた面として表現する。

image::images/401.png["",200,title=" 図　wtr:WaterBodyの例（LOD1）"]

2+a| 
LOD2は、水面と水底面に囲まれた立体として表現する。

image::images/402.png["",400,title=" 図　wtr:WaterBodyの例（LOD2）"]

2+a| 
LOD3は、水面と水底面に囲まれた立体から、水中の構造物を除いた立体として表現する。

image::images/403.png["",400,title=" 図　wtr:WaterBodyの例（LOD3）"]
...
image::images/404.png["",500,title=" 図　水部の断面イメージ"]
...
image::images/405.png["",500,title=" 図　水部の断面イメージ"]
...
image::images/406.png["",500,title=" 図　水部の断面イメージ"]
