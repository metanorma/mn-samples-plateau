...
h| 5+^h| LOD0
h| 取得例
5+^a| image::images/104.webp.png["",150]

h| 説明 5+| 中心線を取得する。
h| 5+^h| LOD0
h| 取得例
^a| image::images/105.webp.png["",150]
^a| image::images/106.webp.png["",150]
^a| image::images/107.webp.png["",150]
^a| image::images/108.webp.png["",150]
^a| image::images/109.webp.png["",150]
...
h| 2+^h| LOD1
h| 取得例
^a| image::images/110.webp.png["",370]
^a| image::images/111.webp.png["",350]
...
h| 2+^h| LOD1
h| 取得例
^a| image::images/112.webp.png["",350]
|
...
image::images/113.webp.png[title=" 図 4-4　線路の構造"]
...
h| ^h| LOD2
h| 取得例
a| image::images/114.webp.png["",500]
...
h| 取得例
^a| image::images/115.webp.png["",200]
^a| image::images/116.webp.png["",250]
^a| image::images/117.webp.png["",250]
...
h| ^h| LOD3.0 ^h| LOD3.1 ^h| LOD3.2
h| 取得例
^a| image::images/118.webp.png["",150]
^a| image::images/119.webp.png["",180]
^a| image::images/120.webp.png["",180]
...
a| image::images/123.webp.png["",150]
...
a| image::images/124.webp.png["",150]
...
| • レールに囲まれた範囲
| • 左右レールの内側を境界とする面を取得する。 • 各頂点に軌道の高さを与える。
a| image::images/125.webp.png["",150]
...
image::images/128.webp.png["",350,title=" 図　LOD0における鉄道の取得例"]

2+a| image::images/129.webp.png["",370,title=" 図　LOD1における鉄道の取得例"]

2+a| image::images/130.webp.png["",650,title=" 図　LOD2における鉄道の取得例"]

2+a| image::images/131.webp.png["",650,title=" 図　LOD3における鉄道の取得例"]
...
image::images/132.webp.png["",500,title=" 図　LOD2における鉄道のtran:TrafficAreaの例"]

2+a|
• LOD3.0の場合は軌道中心線に加え、道床の外周に囲まれた範囲を取得する。軌道中心線の各頂点には、軌道中心線上の勾配変化点の標高に基づき、高さを与える。また、道床の高さは、軌道中心線上の高さとする。

image::images/133.webp.png["",500,title=" 図　LOD3.0における鉄道のtran:TrafficAreaの例"]

2+a|
• LOD3.1の場合は、LOD3.0の軌道中心線、道床に加え、レールを取得する。高さはそれぞれの水平位置における標高とする。15㎝以上の高さの差を取得する。

image::images/134.webp.png["",500,title=" 図　LOD3.1における鉄道のtran:TrafficAreaの例"]

2+a|
• LOD3.2の場合は、LOD3.1の軌道中心線、道床及びレールの範囲を取得する。高さはそれぞれの水平位置における標高とする。15㎝未満の高さの差を取得する。

image::images/135.webp.png["",500,title=" 図　LOD3.2におけるtran:TrafficAreaの例"]
...
image::images/136.webp.png["",500,title=" 図　LOD3.1におけるtran:AuxiliaryTrafficAreaの例"]

2+a|
• LOD3.2の場合は、鉄道敷地界及び道床の外周に囲まれた範囲を取得する。高さはそれぞれの水平位置における標高とする。15㎝未満の高さの差を取得する。

image::images/137.webp.png["",500,title=" 図　LOD3.2におけるtran:AuxiliaryTrafficAreaの例"]
