...
| 5+^| LOD0
| 取得例
a| image::images/297.png["",150]
a| image::images/298.png["",150]
a| image::images/299.png["",160]
a| image::images/300.png["",130]
a| image::images/301.png["",130]
...
| 5+^| LOD0
| 取得例
2+a| image::images/302.png["",300]
a| image::images/303.png["",150]
a| image::images/304.png["",150]
a| image::images/305.png["",130]
...
| 4+^| LOD1
| 取得例
a| image::images/306.png["",170]
a| image::images/307.png["",170]
a| image::images/308.png["",160]
a| image::images/309.png["",170]
...
| 4+^| LOD1
| 取得例
a| image::images/310.png["",170]
a| image::images/311.png["",190]
a| image::images/312.png["",170]
a| image::images/313.png["",170]
...
| 4+^| LOD2
| 取得例
a| image::images/314.png["",170]
a| image::images/315.png["",150]
a| image::images/316.png["",150]
a| image::images/317.png["",150]
...
| 4+^| LOD2
| 取得例
a| image::images/318.png["",170]
a| image::images/319.png["",150]
a| image::images/320.png["",150]
a| image::images/321.png["",150]

| 説明 | 構造物の上方からの正射影の外周を取得し、構造物が埋設された深さから構造物の高さで下向きに押し出した立体を作成する。 | 弁栓類、ガバナ等の設備を包含する矩形の正射影を、設備が埋設された深さから設備の高さで下向きに押し出した立体として表現する。 | マンホール本体の上方からの正射影の外周※1を、地表面からマンホールの深さで下向きに押し出した立体を作成する。 | ハンドホールの規格により定まる外径とハンドホールの中心をもとに推定したハンドホール本体の上方からの正射影の外周を、地表面からハンドホールの深さで下向きに押し出した立体を作成する。
...
image::images/322.png[title=" 図 4-7　マンホールの取得の差異"]
...
| 4+^| LOD3
| 取得例
a| image::images/323.png["",150]
a| image::images/324.png["",150]
a| image::images/325.png["",150]
a| image::images/326.png["",150]

| 説明 | 管路の外形を構成する面を取得する。 | 複数まとまって埋設されている管路も、個々の管路の外形を構成する面を取得する。 | ケーブルの外形を構成する面を取得する。 | 複数まとまって埋設されているケーブルも、個々のケーブルの外形を構成する面を取得する。
| 4+^| LOD3
| 取得例
a| image::images/327.png["",150]
a| image::images/328.png["",150]
a| image::images/329.png["",150]
a| image::images/330.png["",150]
...
| 4+^| LOD4
| 取得例
a| image::images/332.png["",150]
a| image::images/333.png["",150]
a| image::images/334.png["",180]
a| image::images/335.png["",160]

| 説明 | 管路の外形を構成する面（埋設物モデル（LOD3））に加え、管路の内空を構成する面を取得する。 | 複数まとまって埋設されている管路の外形を構成する面（地下埋設物モデル（LOD3））に加え、各管路の内空を構成する面を取得する。 | 構造物の外形を構成する面を取得する。構造物のLOD4 を作成する場合は、構造物の内側の面を作成する。構造物に格納されている管路のLOD4を作成する場合は、各管路も、個々の管路の外形を構成する面に加え、内空を構成する面を取得する。 | マンホール・ハンドホール等の外形を構成する面（地下埋設物モデル（LOD3））に加え、内部を構成する面を取得する。
...
| (gml:boundedBy) | gml:Envelope [0..1] | 埋設物の範囲及び適用される空間参照系。
...
| (frn:usage) | gml:CodeType [0..*] | 埋設物の主な使い道。
...
| 上位の型 2+| uro:UtilityNodeContainer
| ステレオタイプ 2+| << FeatureType >>
3+| 継承する属性
| 属性名 | 属性の型及び多重度 | 定義
| gml:description | gml:StringOrRefType [0..1] | 埋設物の概要。
...
| (uro:horizontalType) | gml:CodeType [0..1] | uro:shapeがもつ水平位置の種類。

|===

===== 15)　uro:LengthAttribute
...
===== 16)　uro:FacilityIdAttribute

施設管理属性の応用スキーマ文書　参照。

　

===== 17)　uro:FacilityTypeAttribute

施設管理属性の応用スキーマ文書　参照。

　

===== 18)　uro:FacilityAttribute
...
===== 20)　uro:CityFurnitureDetailAttribute

都市設備モデルの応用スキーマ文書　参照。

　

===== 21)　uro:KeyValuePairAttribute
...
===== 1)　UtilityNetworkElement_occupierType.xml

[cols="3,22"]
|===
| ファイル名 | UtilityNetworkElement_occupierType.xml

| ファイルURL | https://www.geospatial.jp/iur/codelists/3.1/UtilityNetworkElement_occupierType.xml
| コード | 説明
| 100 | 道路管理者
| 200 | 通信
| 300 | 電力
...
===== 2) UtilityNetworkElement_occupierName.xml

[cols="3,22"]
|===
| ファイル名 | UtilityNetworkElement_occupierName.xml

| ファイルURL | https://www.geospatial.jp/iur/codelists/3.1/UtilityNetworkElement_occupierName.xml
| コード | 説明
| 1 | 国土交通省
| 2 | 東京都
| 3 | 東京電力パワーグリッド株式会社
...
===== 3)　UtilityNetworkElement_yearType.xml

[cols="3,22"]
|===
| ファイル名 | UtilityNetworkElement_yearType.xml

| ファイルURL | https://www.geospatial.jp/iur/codelists/3.1/UtilityNetworkElement_yearType.xml
| コード | 説明
| 0 | 確定
| 6 | 不明
| 7 | 頃
...
===== 4) UtilityNetworkElement_administrator.xml

[cols="3,22"]
|===
| ファイル名 | UtilityNetworkElement_administrator.xml

| ファイルURL | https://www.geospatial.jp/iur/codelists/3.1/UtilityNetworkElement_administrator.xml[https://www.geospatial.jp/iur/codelists/3.1/ UtilityNetworkElement_administrator.xml]
| コード | 説明
| 1 | 国土交通省
| 2 | 東京都
| 3 | 東京電力パワーグリッド株式会社
...
===== 5) UtilityNetworkElement_material.xml

[cols="3,22"]
|===
| ファイル名 | UtilityNetworkElement_material.xml

| ファイルURL | https://www.geospatial.jp/iur/codelists/3.1/ UtilityNetworkElement_material.xml
| コード | 説明
| 1 | 金属
| 2 | 合成樹脂
| 3 | 陶器：CP
...
===== 6)　Pipe_sleeveType.xml

[cols="3,22"]
|===
| ファイル名 | Pipe_sleeveType.xml

| ファイルURL | https://www.geospatial.jp/iur/codelists/3.1/Pipe_sleeveType.xml
| コード | 説明
| 0 | 被覆なし
| 1 | 継手のみ被覆
| 2 | パイプ、継手、被覆
...
===== 7)　Appurtenance_appurtenanceType.xml

[cols="3,22"]
|===
| ファイル名 | Appurtenance_appurtenanceType.xml

| ファイルURL | https://www.geospatial.jp/iur/codelists/3.1/Appurtenance_appurtenanceType.xml
| コード | 説明
| 410 | ガバナ
| 420 | バルブ
| 430 | 水取器
...
===== 8)　UtilityNodeContainer_containerType.xml

[cols="3,22"]
|===
| ファイル名 | UtilityNodeContainer_containerType.xml

| ファイルURL | https://www.geospatial.jp/iur/codelists/3.1/UtilityNodeContainer_containerType.xml
| コード | 説明
| 501 | 制水弁室
| 502 | 泥吐室
| 503 | 量水器室
...
===== 9)　ThematicShape_heightType.xml

[cols="3,22"]
|===
| ファイル名 | ThematicShape_heightType.xml

| ファイルURL | https://www.geospatial.jp/iur/codelists/3.1/ThematicShape_heightType.xml
| コード | 説明
| 1 | 地下埋設物の中心の高さ
| 2 | 地表の高さ
| 3 | 土被り
...
===== 10)　LengthAttribute_measureType.xml

[cols="3,22"]
|===
| ファイル名 | LengthAttribute_measureType.xml

| ファイルURL | https://www.geospatial.jp/iur/codelists/3.1/LengthAttribute_measureType.xml
| コード | 説明
| 1 | 実延長
| 2 | 亘長
...
===== 11) 　LengthAttribute_phaseType.xml

[cols="3,22"]
|===
| ファイル名 | LengthAttribute_phaseType.xml

| ファイルURL | https://www.geospatial.jp/iur/codelists/3.1/LengthAttribute_phaseType.xml
| コード | 説明
| 1 | 竣工
| 2 | 設計
| 3 | 調査
...
===== 12)　DataQualityAttribute_geometrySrcDesc.xml
...
===== 13)　 DataQualityAttribute_thematicSrcDesc.xml
...
===== 14)　 DataQualityAttribute_appearanceSrcDesc.xml
...
===== 15)　 DataQualityAttribute_lod1HeightType.xml
