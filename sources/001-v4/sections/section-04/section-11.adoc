...
ただし、IFCにおける橋梁モデルはまだ国際標準となっていないことから、 <<ifc_bridge_wp2,IFC Bridge Fast Track Project Report WP2: Conceptual Model>> を参考に、IFC Bridgeを構成するクラスとCityGMLのBridgeモジュールとの対応付けを示す（表 4-67）。
