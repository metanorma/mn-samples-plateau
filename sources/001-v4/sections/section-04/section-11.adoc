...
image::images/240.webp.png[title="橋梁の部材の名称"]
...
image::images/250.webp.png[title="IfcBridgeにおけるクラス間の階層構造（出典：IFC Bridge Fast Track Project Report WP2: Conceptual Model）"]
