...
[gml_dictionary,iur/codelists/3.1/OtherConstruction_class.xml,root]
----
...
[gml_dictionary,iur/codelists/3.1/OtherConstruction_function.xml,root]
----
{% render 'gml_dict_template', root: root, filename: filename %}
----
...
[gml_dictionary,iur/codelists/3.1/ConstructionInstallation_function.xml,root]
----
{% render 'gml_dict_template', root: root, filename: filename %}
----
...
[gml_dictionary,iur/codelists/3.1/ConstructionBaseAttribute_purpose.xml,root]
----
{% render 'gml_dict_template', root: root, filename: filename %}
----
...
[gml_dictionary,iur/codelists/3.1/ConstructionStructureAttribute_structureType.xml,root]
----
{% render 'gml_dict_template', root: root, filename: filename %}
----
...
[gml_dictionary,iur/codelists/3.1/ConstructionFunctionalAttribute_directionType.xml,root]
----
{% render 'gml_dict_template', root: root, filename: filename %}
----
...
[gml_dictionary,iur/codelists/3.1/OtherConstruction_lodType.xml,root]
----
{% render 'gml_dict_template', root: root, filename: filename %}
----
...
[gml_dictionary,iur/codelists/3.1/Elevation_elevationReference.xml,root]
----
{% render 'gml_dict_template', root: root, filename: filename %}
----
