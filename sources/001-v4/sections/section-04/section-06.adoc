...
image::images/165.webp.png["",350]

a|
駅前広場

image::images/166.webp.png["",340]
...
image::images/167.webp.png["",370]

自動車ターミナル

^a|

image::images/168.webp.png["",350]
...
image::images/169.webp.png["",460]

交通広場

^a|

image::images/170.webp.png["",460]
...
h| LOD ^h| LOD1
h| 取得例
a| image::images/171.webp.png["",500]
...
h| LOD ^h| LOD2
h| 取得例
a| image::images/172.webp.png["",500]
...
|===
2+h| 交通（広場）モデル（LOD3）に含むべき地物 h| 対応するCityGMLの地物型 ^h| LOD3.0 ^h| LOD3.1 ^h| LOD3.2 ^h| LOD3.3 ^h| LOD3.4
...
^a| image::images/173.webp.png["",150]
^a| image::images/174.webp.png["",210]
^a| image::images/175.webp.png["",220]
^a| image::images/176.webp.png["",250]
...
image::images/179.webp.png["",270]

a|
②15㎝以上のスロープは、スロープの形状を取得する。

image::images/180.webp.png["",270]

a|
②2㎝以上のスロープは、スロープの形状を取得する。

image::images/181.webp.png["",270]

.2+a|
③高さの差が15㎝未満の段が複数あり、合計15㎝以上の高さの差がある場合は、スロープとして取得する。

image::images/182.webp.png["",270]
...
image::images/183.webp.png["",270]

a|
歩道に設けられた切り下げ部に存在する段が表現できる。

image::images/184.webp.png["",300]
