...
[gml_dictionary,iur/codelists/3.1/Square_function.xml,root]
----
...
[gml_dictionary,iur/codelists/3.1/Common_status.xml,root]
----
{% render 'gml_dict_template', root: root, filename: filename %}
----
...
[gml_dictionary,iur/codelists/3.1/StationSquareAttribute_railwayType.xml,root]
----
{% render 'gml_dict_template', root: root, filename: filename %}
----
...
[gml_dictionary,iur/codelists/3.1/TerminalAttribute \_userType.xml,root]
----
{% render 'gml_dict_template', root: root, filename: filename %}
----
...
[gml_dictionary,iur/codelists/3.1/TerminalAttribute_terminalType.xml,root]
----
{% render 'gml_dict_template', root: root, filename: filename %}
----
