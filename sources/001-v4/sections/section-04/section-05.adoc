...
[gml_dictionary,iur/codelists/3.1/Track_function.xml,root]
----
...
[gml_dictionary,iur/codelists/3.1/TrackAttribute_adminType.xml,root]
----
{% render 'gml_dict_template', root: root, filename: filename %}
----
...
[gml_dictionary,iur/codelists/3.1/TrackAttribute_structureType.xml,root]
----
{% render 'gml_dict_template', root: root, filename: filename %}
----
...
[gml_dictionary,iur/codelists/3.1/TrackAttribute_widthType.xml,root]
----
{% render 'gml_dict_template', root: root, filename: filename %}
----
