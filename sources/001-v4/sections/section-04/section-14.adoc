...
[gml_dictionary,iur/codelists/3.1/CityFurniture_class.xml,root]
----
...
[gml_dictionary,iur/codelists/3.1/CityFurniture_function.xml,root]
----
{% render 'gml_dict_template', root: root, filename: filename %}
----
...
[gml_dictionary,iur/codelists/3.1/CityFurniture_lodType.xml,root]
----
{% render 'gml_dict_template', root: root, filename: filename %}
----
...
[gml_dictionary,iur/codelists/3.1/CityFurnitureDetailAttribute_facilityType.xml,root]
----
{% render 'gml_dict_template', root: root, filename: filename %}
----
