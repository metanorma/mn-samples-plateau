...
[gml_dictionary,iur/codelists/3.1/Tunnel_class.xml,root]
----
...
[gml_dictionary,iur/codelists/3.1/Tunnel_function.xml,root]
----
{% render 'gml_dict_template', root: root, filename: filename %}
----
...
[gml_dictionary,iur/codelists/3.1/TunnelInstallation_function.xml,root]
----
{% render 'gml_dict_template', root: root, filename: filename %}
----
...
[gml_dictionary,iur/codelists/3.1/TunnelFunctionalAttribute_userType.xml,root]
----
{% render 'gml_dict_template', root: root, filename: filename %}
----
...
[gml_dictionary,iur/codelists/3.1/TunnelStructureAttribute_tunnelType.xml,root]
----
{% render 'gml_dict_template', root: root, filename: filename %}
----
...
[gml_dictionary,iur/codelists/3.1/TunnelStructureAttribute_tunnelSubType.xml,root]
----
{% render 'gml_dict_template', root: root, filename: filename %}
----
...
[gml_dictionary,iur/codelists/3.1/TunnelStructureAttribute_mouthType.xml,root]
----
{% render 'gml_dict_template', root: root, filename: filename %}
----
...
[gml_dictionary,iur/codelists/3.1/Tunnel_lodType.xml,root]
----
{% render 'gml_dict_template', root: root, filename: filename %}
----
