...
| 5+^| LOD0
| 取得例
^a| image::images/368.png["",150]
^a| image::images/369.png["",150]
^a| image::images/370.png["",130]
^a| image::images/371.png["",170]
^a| image::images/372.png["",150]

| 説明 | 等高線及び等深線は等値線を取得する。 | 凹地は高い方を左に見るように等値線を取得する。 | 凹地（小）は高い方を1点目、低い方を2点目として取得する。 | 洞口は正射影の方向に一致させて記号を表示する。 | 露岩は、高度の高い方を右に見る形で界線を取得する。
| 5+^| LOD0
| 取得例
^a| image::images/373.png["",120]
^a| image::images/374.png["",150]
^a| image::images/375.png["",170]
^a| image::images/376.png["",150]
^a| image::images/377.png["",170]
...
| 2+^| LOD1
| 取得例
^a| image::images/378.png["",350]
^a| image::images/379.png["",400]
...
image::images/382.png["",300,title=" 図　dem:TINReliefの例"]
...
image::images/383.png["",300,title=" 図　dem:MassPointReliefの例"]
...
image::images/384.png["",300,title=" 図　dem:BreaklineReliefの例"]
