...
[cols="5,9,9,9,9,9"]
.表 4-107　地形モデル（LOD0）の取得イメージ
|===
| 5+^| LOD0
| 取得例
^a| image::images/368.webp["",150]
^a| image::images/369.webp["",150]
^a| image::images/370.webp["",130]
^a| image::images/371.webp["",170]
^a| image::images/372.webp["",150]

| 説明 | 等高線及び等深線は等値線を取得する。 | 凹地は高い方を左に見るように等値線を取得する。 | 凹地（小）は高い方を1点目、低い方を2点目として取得する。 | 洞口は正射影の方向に一致させて記号を表示する。 | 露岩は、高度の高い方を右に見る形で界線を取得する。
| 5+^| LOD0
| 取得例
^a| image::images/373.webp["",120]
^a| image::images/374.webp["",150]
^a| image::images/375.webp["",170]
^a| image::images/376.webp["",150]
^a| image::images/377.webp["",170]
...
[cols="2,9,9"]
.表 4-108　地形モデル（LOD1）の取得イメージ
|===
| 2+^| LOD1
| 取得例
^a| image::images/378.webp["",350]
^a| image::images/379.webp["",400]
...
image::images/382.webp["",300,title=" 図　dem:TINReliefの例"]

| 上位の型 2+| dem:_ReliefComponent
| ステレオタイプ 2+| << FeatureType >>
3+| 継承する属性
| 属性名 | 属性の型及び多重度 | 定義
| gml:description | gml:StringOrRefType [0..1] | 地形の概要。
...
image::images/383.webp["",300,title=" 図　dem:MassPointReliefの例"]
...
image::images/384.webp["",300,title=" 図　dem:BreaklineReliefの例"]
...
| (dem:breaklines) | gml:MultiMultiCurve [0..1] | 抑止線を表現する線の集まり。
...
===== 4)　 PublicSurveyDataQualityAttribute_srcScale.xml
...
===== 5)　 PublicSurveyDataQualityAttribute_geometrySrcDesc.xml
