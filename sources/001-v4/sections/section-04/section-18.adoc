...
lutaml_klass_table::../../sources/xmi/plateau_all_packages_export.xmi[name="ReliefFeature",template="../../sources/liquid_templates/_klass_table.liquid",guidance="../../sources/guidance/guidance.yaml"]
...
lutaml_klass_table::../../sources/xmi/plateau_all_packages_export.xmi[name="TINRelief",template="../../sources/liquid_templates/_klass_table.liquid",guidance="../../sources/guidance/guidance.yaml"]
...
lutaml_klass_table::../../sources/xmi/plateau_all_packages_export.xmi[name="MassPointRelief",template="../../sources/liquid_templates/_klass_table.liquid",guidance="../../sources/guidance/guidance.yaml"]
...
lutaml_klass_table::../../sources/xmi/plateau_all_packages_export.xmi[name="BreaklineRelief",template="../../sources/liquid_templates/_klass_table.liquid",guidance="../../sources/guidance/guidance.yaml"]
