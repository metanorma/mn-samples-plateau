...
=== Building Firelight using containers

This example assumes:

- You are building document PLATEAU 01.
- You want to build *without* the `/plateaudocument01` path prefix as used in Plateau production deployment environment.
...
(Do not add this file in Git, you will only use it for local build.)
